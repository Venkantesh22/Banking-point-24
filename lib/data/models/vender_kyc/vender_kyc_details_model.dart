class VenderKycDetails {
  ...
  factory VenderKycDetails.fromJson(Map<String, dynamic> json) =>
      VenderKycDetails(
        id: json["id"],
        userId: json["user_id"],
        status: json["status"],
        ...
        businessStartDate: json["business_start_date"] == null
            ? null
            : DateTime.parse(json["business_start_date"]),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "business_start_date": businessStartDate == null
            ? null
            : "${businessStartDate!.year.toString().padLeft(4, '0')}-${businessStartDate!.month.toString().padLeft(2, '0')}-${businessStartDate!.day.toString().padLeft(2, '0')}",
