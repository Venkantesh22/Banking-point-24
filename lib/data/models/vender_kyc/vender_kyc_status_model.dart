...
class VenderKycStatusModel {
    ...
    factory VenderKycStatusModel.fromJson(Map<String, dynamic> json) => VenderKycStatusModel(
        status: json["status"],
        kycStatus: json["kyc_status"],
        correctionRemarks: json["correction_remarks"] == null ? null : CorrectionRemarks.fromJson(json["correction_remarks"]),
...
class CorrectionRemarks {
    ...
    factory CorrectionRemarks.fromJson(Map<String, dynamic> json) => CorrectionRemarks(
        verifiedSections: json["verified_sections"] == null ? [] : List<String>.from(json["verified_sections"]!.map((x) => x)),
    ...
    Map<String, dynamic> toJson() => {
        "verified_sections": verifiedSections == null ? [] : List<dynamic>.from(verifiedSections!.map((x) => x)),
