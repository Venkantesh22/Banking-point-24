...
//           builder: (controller) {
//             // Get the list of screens to know how many circles to generate
...
//                   demoData
//                       .length, // Creates exactly as many circles as your list
//                   (index) {
//                     bool isSelected = controller.demoPage == index;
        ...
        child: GetBuilder<BasicController>(
          builder: (controller) {
            ...
            return Padding(
              padding: EdgeInsets.symmetric(horizontal: 20.w, vertical: 20.h),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween, // ✅ Spreads items Left, Center, Right
                children: [
